...
@keyframes pulseBtn {0%,100%{box-shadow:0 0 10px cyan;}50%{box-shadow:0 0 20px cyan;}}
...
.hof {
    max-width: 800px; margin: 40px auto; padding: 15px;
...
<h1>IRONPS GTPS</h1>
<div class="marquee"><span>🔥 Welcome to IRONPS GTPS | 💎 Free VIP + Free Mods | 🎉 Event Harian Menarik | 🚀 Server No Lag 24/7</span></div>
...
<div class="hof">
<h2>🏆 Hall of Fame</h2>
<p>1. PlayerPro - 500 Wins</p>
<p>2. BuilderX - 450 Builds</p>
<p>3. FarmerMax - 400 Farms</p>
</div>

<!-- 🎰 Mini Event 1: Gacha Angka -->
<div class="event-box">
<h2>🎰 Gacha Angka</h2>
...
function createStars(){
    stars=[]; for(let i=0;i<150;i++){ stars.push({
